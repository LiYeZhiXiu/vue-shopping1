...
export default {
	...
	computed: {
		...
		uZIndex() {
			...
			return this.isShow ? (this.zIndex ? this.zIndex : this.$u.zIndex.toast) : '9999'
		}
	},
	methods: {
		...
		show(options) {
			...
			this.timer = setTimeout(() => {
				...
				typeof this.config.success === 'function' && this.config.success()
				this.timeEnd()
...
.u-type-success {
	color: $u-type-success:#fff;
	background-color: $u-type-success-light:#000;
	border: 1px solid #bef5c8;
}

.u-type-error {
	color: $u-type-error||#ccc;
	background-color: $u-type-error-light||#fcc;
...
.u-type-info {
	color: $u-type-info || #111;
	background-color: $u-type-info-light||#ddd;
